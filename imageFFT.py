...
col_150, s_150  = col_fft_abs(img,2760)
...
plt.figure(figsize=(130,40), dpi=100, linewidth=0.9)
plot_f(411,del_f,s_45k,test,'s_45k')
plot_f(412,del_f,s_15c,test,'s_15c')
plot_f(413,del_f,s_30m,test,'s_30m')
plot_f(414,del_f,s_90y,test,'s_90y')
plt.savefig("FFT_45k_15c_30m_90y_{x}.png".format(x=test))

plt.figure(figsize=(130,40), dpi=100, linewidth=0.9)
plot_f(411,del_f,s_50,test,'s_50')
plot_f(412,del_f,s_75,test,'s_75')
plot_f(413,del_f,s_100,test,'s_100')
plot_f(414,del_f,s_150,test,'s_150')
plt.savefig("FFT_50_75_100_150_{x}.png".format(x=test))

plt.figure(figsize=(130,40), dpi=100, linewidth=0.9)
plot_f(211,del_f,s_75i,test,'s_75i')
plot_f(212,del_f,s_100i,test,'s_100i')
plt.savefig("FFT_75i_100i_{x}.png".format(x=test))

plt.figure(figsize=(130,40), dpi=100, linewidth=0.9)
plot_f(411,del_f,s_r,test,'s_r')
plot_f(412,del_f,s_g,test,'s_g')
plot_f(413,del_f,s_b,test,'s_b')
plot_f(414,del_f,s_blk,test,'s_blk')
