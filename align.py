...
img1 = 'MFP_good_1'         #MFP_good_1  #MFP_good_MTF_600dpi-color_1        #_good_600dpi_test 4000*7000 3800~3950
img2 = 'MFP_60T-brokengear_2'   #MFP_brokengear_1  #MFP_defect_MTF_600dpi-color_1  _defect_600dpi_test 4500~4640
...
x1_left,y1_left = scan(890, 980, 130, 300, im1_gray) # get im1 left mark   500, 1000, 50, 300,
x2_left,y2_left = scan(890, 980, 130, 300, im2_gray) # get im2 left mark
...
x2_mov_left,y2_mov_left = scan(890, 980, 130, 300, im2_mov_gray)  # confirm part
...
x1_right,y1_right = scan(890, 980, 4591, 4640, im1_gray)     # get im1 right mark  500, 1000, 3800, 3950,
x2_mov_right,y2_mov_right = scan(890, 980, 4591, 4640, im2_mov_gray) # get im2(moved) right mark
