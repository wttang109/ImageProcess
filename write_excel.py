...
datas['150lppi_good'] = a_g_150.tolist()
datas['100lppi_good'] = a_g_100.tolist()
datas['150lppi_bad'] = a_b_150.tolist()
datas['100lppi_bad'] = a_b_100.tolist()

cols = pd.DataFrame(columns = listk)

for id in listk:
    cols[id] = datas[id]
cols.to_csv('FFT降噪處理_588_1116.csv')
